package com.example.Wassup.db.mongodb;

import java.text.ParseException;

import com.example.Wassup.db.mongodb.MongoDBUtil;
...
public class MongoDBTableCreation {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        db.getCollection("users").insertOne( new Document().append("user_id", "1111").append("password",
                "3229c1097c00d497a0fd282d586be050").append("first_name", "John").append("last_name","Smith"));
        mongoClient.close();
